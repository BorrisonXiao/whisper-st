...
bayes_mtl=true                 # Whether to use Bayesian decomposition for the multi-task learning
...
min_sample_prob=0.2            # The minimum probability for sampling the BMTL ASR hypothesis
max_sample_prob=0.8            # The maximum probability for sampling the BMTL ASR hypothesis (0.0 means disable sampling)
