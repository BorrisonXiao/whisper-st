...
if ! "${skip_data_prep}"; then
    ...
    # Directly create MT data from the MT training set
    ls ${datadir}/${mt_train_set}
    python pyscripts/utils/create_dataset_mt.py \
        --raw-data-location ${datadir}/${mt_train_set} \
        --output-path ${org_hf_datadir}/${src_lang}.${mt_train_set} \
        --src-lang ${src_lang}
