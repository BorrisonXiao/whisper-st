...
SCRIPTDIR=/home/hltcoe/cxiao/scale23/st/evaluation/mwerSegment
sourcesgmfile=$1
referencesgmfile=$2
translationfile=$3
sysid=$4
...
# $SCRIPTDIR/hyp2sgm.py --source=$sourcesgmfile --id=$sysid --targetLang=${language} $tmpdir/$tmpresegmentedfile 
