...
outdir=/exp/cxiao/scale23/multi_st_decode/pmtl_ref
...
python_hf=python3
evaldir=evaluation
scoredir=/home/hltcoe/cxiao/scale23/st/evaluation/scores_tmp/pmtl_ref/e2e_st/hf_whisper_large-v2/spa/lora_0.5_0.8/train-cts_sp/merged_org/fisher_test
sclite_path=sclite
debug=false
eval_cer=false
num_beams=1
