...
src_langs="fr"
tgt_lang="en"
logdir=/home/hltcoe/cxiao/scale23/st/logs/seamless_covost2
outdir=/exp/cxiao/scale23/seamless_decode_covost2
inference_batch_size=16
inference_nj=4
hf_datadir=/exp/cxiao/scale23/hf_data_covost2/${src_langs}
evaldir=evaluation
scoredir=/home/hltcoe/cxiao/scale23/st/evaluation/scores_seamless_covost2
no_glm=true
debug=false
num_beams=1
task=ASR
...
if [ ${stage} -le 1 ] && [ ${stop_stage} -ge 1 ]; then
    for src_lang in ${src_langs}; do
        ...
        for dset in ${test_sets}; do
            ...
            _logdir="${logdir}/inference/${task}/${src_lang}/${dset}"
            mkdir -p "${_logdir}"
